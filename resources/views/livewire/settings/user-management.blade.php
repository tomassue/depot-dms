                ...
                <div class="modal-body">
                    <form class="forms-sample" wire:submit="{{ $editMode ? 'updateUser' : 'createUser' }}" novalidate>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('username') is-invalid @enderror" id="exampleInputUsername1" placeholder="Username" wire:model="username">
                            @error('username')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="exampleInputName" placeholder="Username" wire:model="name">
                            @error('name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control @error('name') is-invalid @enderror" id="exampleInputEmail1" placeholder="Email" wire:model="email">
                            @error('email')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
        ...
        columns: [{
            ...
            "Email",
            {
                ...
                formatter: (cell, row) => {
                    ...
                    <button class="btn btn-dark btn-sm btn-icon-text me-3" wire:click="readUserRole('${id}')"> Role <i class="typcn typcn-user-outline btn-icon-append"></i></button>
                    `);
                }
            }
        ],
